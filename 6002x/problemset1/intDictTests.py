...
def calculate_largestSize(probability, sampleSpace, insertions = 1):

    prob = 1.0
    for i in range(insertions):
        prob = prob*(sampleSpace-i)/sampleSpace
    if (float("{0:.2f}".format(1-prob)) >= 0.99):
        return insertions
    return calculate_largestSize(probability,sampleSpace,insertions+1)
...
print collision_prob(365,110)

print calculate_largestSize(0.99,365)
