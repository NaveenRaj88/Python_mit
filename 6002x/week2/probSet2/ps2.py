...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        # random.seed(0)
        w = random.randint(0,len(self.room)-1)
        h = random.randint(0, len(self.room[0])-1)
        return Position(w,h)
    ...
    def isPositionInRoom(self, pos):
        ...
        try:
            i = self.room[int(pos.getX())][int(pos.getY())]
            return True
        except IndexError:
            return False
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    while num > 0:
        ...
        minCleanTiles = min_coverage*room.getNumTiles()
        robots=[]
