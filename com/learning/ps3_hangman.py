...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the
    ...
    '''
    # FILL IN YOUR CODE HERE...
    guessInLowerCase= secretWord.lower()
    guessesLeft=8
    lettersGuessed=[]
    print 'Welcome to the game, Hangman!'
    print ('I am thinking of a word that is '+str(len(guessInLowerCase))+' letters long')
    while guessesLeft > 0:
        print('-------------')
        ...
        if guess in lettersGuessed:
            ...
            continue
        elif guess in guessInLowerCase:
            lettersGuessed.append(guess)
            print('Good guess: '+getGuessedWord(guessInLowerCase,lettersGuessed))
            if isWordGuessed(guessInLowerCase,lettersGuessed):
                break
        else:
            lettersGuessed.append(guess)
    ...
    if(isWordGuessed(guessInLowerCase,lettersGuessed)):
        ...
        print "Sorry, you ran out of guesses. The word was "+guessInLowerCase
